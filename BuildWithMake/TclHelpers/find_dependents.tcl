...
find_dependents [glob /usr/local/sv/ext/bin/msvc-12.5/x64/mitk-2016.03/bin/plugins/RelWithDebInfo/*.dll]

#find_dependents /usr/local/sv/ext/bin/msvc-12.5/x64/mitk-2016.03/bin/RelWithDebInfo/MitkWorkbench.exe
#find_dependents [glob /usr/local/sv/ext/bin/msvc-12.5/x64/mitk-2016.03/bin/plugins/RelWithDebInfo/*.dll]
