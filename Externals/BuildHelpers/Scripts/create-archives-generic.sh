...
if [[ $SV_SUPER_OPTIONS == *ARCHIVE_SWIG* ]]; then
  echo "ARCHIVE_SWIG"
  pushd REPLACEME_SV_TOPLEVEL_BINDIR/REPLACEME_SV_COMPILER_BIN_DIR/REPLACEME_SV_ARCH_DIR
  REPLACEME_TAR -cvzf REPLACEME_SV_PLATFORM.REPLACEME_SV_COMPILER_BIN_DIR.REPLACEME_SV_ARCH_DIR.REPLACEME_SV_SWIG_DIR-BUILD${BUILDDATE}.tar.gz REPLACEME_SV_SWIG_DIR
  popd
  mv REPLACEME_SV_TOPLEVEL_BINDIR/REPLACEME_SV_COMPILER_BIN_DIR/REPLACEME_SV_ARCH_DIR/REPLACEME_SV_PLATFORM.REPLACEME_SV_COMPILER_BIN_DIR.REPLACEME_SV_ARCH_DIR.REPLACEME_SV_SWIG_DIR-BUILD${BUILDDATE}.tar.gz tar_output
fi
...
if [[ $SV_SUPER_OPTIONS == *ARCHIVE_QT* ]]; then
  echo "ARCHIVE_QT"
  pushd REPLACEME_SV_TOPLEVEL_BINDIR/REPLACEME_SV_COMPILER_BIN_DIR/REPLACEME_SV_ARCH_DIR
  REPLACEME_TAR -cvzf REPLACEME_SV_PLATFORM.REPLACEME_SV_COMPILER_BIN_DIR.REPLACEME_SV_ARCH_DIR.REPLACEME_SV_QT_DIR-BUILD${BUILDDATE}.tar.gz REPLACEME_SV_QT_DIR
  popd
  mv REPLACEME_SV_TOPLEVEL_BINDIR/REPLACEME_SV_COMPILER_BIN_DIR/REPLACEME_SV_ARCH_DIR/REPLACEME_SV_PLATFORM.REPLACEME_SV_COMPILER_BIN_DIR.REPLACEME_SV_ARCH_DIR.REPLACEME_SV_QT_DIR-BUILD${BUILDDATE}.tar.gz tar_output
fi
