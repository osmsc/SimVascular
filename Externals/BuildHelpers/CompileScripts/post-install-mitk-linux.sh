...
for i in $MITK_SRCDIR/Modules/*/include; do
    echo "  Copying Modules includes for ($i)"
    $GMKDIR -p $MITK_BINDIR/include/mitk/$($GBASENAME $($GDIRNAME $i))
    $GCP -R $($GDIRNAME $i)/include $MITK_BINDIR/include/mitk/$($GBASENAME $($GDIRNAME $i))
done
...
for i in $MITK_SRCDIR/Modules/*/*/include; do
    ...
    $GCP -R $($GDIRNAME $i)/include $MITK_BINDIR/include/mitk/$($GBASENAME $($GDIRNAME $($GDIRNAME $i)))/$($GBASENAME $($GDIRNAME $i))
done
