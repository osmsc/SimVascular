...
# swig
s+REPLACEME_SV_TOP_SRC_DIR_SWIG+REPLACEME_SV_TOPLEVEL_SRCDIR/REPLACEME_SV_SWIG_DIR+g
s+REPLACEME_SV_TOP_BLD_DIR_SWIG+REPLACEME_SV_TOPLEVEL_BUILDDIR/REPLACEME_SV_COMPILER_BIN_DIR/REPLACEME_SV_ARCH_DIR/REPLACEME_SV_SWIG_DIR+g
s+REPLACEME_SV_TOP_BIN_DIR_SWIG+REPLACEME_SV_TOPLEVEL_BINDIR/REPLACEME_SV_COMPILER_BIN_DIR/REPLACEME_SV_ARCH_DIR/REPLACEME_SV_SWIG_DIR+g
# numpy
...
s+REPLACEME_SV_COMPILER_BIN_DIR+gnu-5.3+g
s+REPLACEME_SV_ARCH_DIR+x64+g

# swig (ubuntu 14.04 swig 3.0 version)

s+REPLACEME_SV_SWIG_EXECUTABLE+bin/swig+g
s+REPLACEME_SV_SWIG_DIR+swig-3.0.12+g
