...
foreach me $module_exports_h {
    puts $ofn "s+[file rootname $me]\\.h+sv4gui_[string range [file rootname $me] 2 end]\\.h+g"
}
foreach md $module_names {
    puts $ofn "s+$md+sv4gui_$md+g"
    puts $ofn "s+[string toupper $md]_EXPORT+[string toupper sv4gui_[string range $md 2 end]]_EXPORT+g"
}
...
foreach md $module_names {
    puts $ofn "s+$md+sv4gui_[string range $md 2 end]+g"
    puts $ofn "s+[string toupper $md]+[string toupper sv4gui_[string range $md 2 end]]+g"
}
